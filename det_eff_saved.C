...
TF1 *tf1_W2_bg_pol8, *tf1_W2_sig, *tf1_W2_fullFit, *tf1_W2_bg_pol8_rej_init, *tf1_W2_bg_pol8_rej_full, *tf1_W2_bg_pol8_rej, *tf1_W2_sig_rej, *tf1_W2_fullFit_rej;
...
//---------------------------------------------
		...
		//----- Then we take the parameters from that and fix the Full Fit BG parametes to match
				...
				tf1_W2_bg_pol8_rej_init = new TF1("tf1_W2_bg_pol8_rej_init", fitPol8_with_reject, 0, 1.4, 9);
				tf1_W2_bg_pol8_rej_init->SetNpx(280);
				h_W2copy->Fit("tf1_W2_bg_pol8_rej_init", "R0+");

				tf1_W2_bg_pol8_rej_init->GetParameters(&parRej[0]);

				tf1_W2_bg_pol8_rej = new TF1("tf1_W2_bg_pol8_rej", fitPol8, 0, 1.4, 9);
				tf1_W2_bg_pol8_rej->SetNpx(280);
				...
				tf1_W2_bg_pol8_rej->FixParameter(0, parRej[0]);
				tf1_W2_bg_pol8_rej->FixParameter(1, parRej[1]);
				tf1_W2_bg_pol8_rej->FixParameter(2, parRej[2]);
				tf1_W2_bg_pol8_rej->FixParameter(3, parRej[3]);
				tf1_W2_bg_pol8_rej->FixParameter(4, parRej[4]);
				tf1_W2_bg_pol8_rej->FixParameter(5, parRej[5]);
				tf1_W2_bg_pol8_rej->FixParameter(6, parRej[6]);
				tf1_W2_bg_pol8_rej->FixParameter(7, parRej[7]);
				tf1_W2_bg_pol8_rej->FixParameter(8, parRej[8]);	

				tf1_W2_bg_pol8_rej->SetLineColor(3);
				// tf1_W2_bg_pol8_rej->Draw("hist+same");

				//Need a new pol8 without the rejection to draw across reject zone:
				tf1_W2_bg_pol8_rej_full = new TF1("tf1_W2_bg_pol8_rej_full", fitPol8, 0, 1.4, 9);
				tf1_W2_bg_pol8_rej_full->SetNpx(280);
				tf1_W2_bg_pol8_rej_full->FixParameter(0, parRej[0]);
				tf1_W2_bg_pol8_rej_full->FixParameter(1, parRej[1]);
				tf1_W2_bg_pol8_rej_full->FixParameter(2, parRej[2]);
				tf1_W2_bg_pol8_rej_full->FixParameter(3, parRej[3]);
				tf1_W2_bg_pol8_rej_full->FixParameter(4, parRej[4]);
				tf1_W2_bg_pol8_rej_full->FixParameter(5, parRej[5]);
				tf1_W2_bg_pol8_rej_full->FixParameter(6, parRej[6]);
				tf1_W2_bg_pol8_rej_full->FixParameter(7, parRej[7]);
				tf1_W2_bg_pol8_rej_full->FixParameter(8, parRej[8]);	


				tf1_W2_bg_pol8_rej_full->SetLineColor(9);	
				h_W2copy->Fit("tf1_W2_bg_pol8_rej_full", "R0+");
				...
				// parRej[8] = 3.2187E+01;
		//----------
			// Using regular fullFitFucntion because we go the BG with Reject just above
				tf1_W2_fullFit_rej = new TF1("tf1_W2_fullFit_rej", fullFitFunction, 0, 1.4, 12);
				...
				tf1_W2_fullFit_rej->SetParName(3, "W2 BG Pol8 p0 (Rej)");
				tf1_W2_fullFit_rej->SetParName(4, "W2 BG Pol8 p1 (Rej)");
				tf1_W2_fullFit_rej->SetParName(5, "W2 BG Pol8 p2 (Rej)");
				tf1_W2_fullFit_rej->SetParName(6, "W2 BG Pol8 p3 (Rej)");
				tf1_W2_fullFit_rej->SetParName(7, "W2 BG Pol8 p4 (Rej)");
				tf1_W2_fullFit_rej->SetParName(8, "W2 BG Pol8 p5 (Rej)");
				tf1_W2_fullFit_rej->SetParName(9, "W2 BG Pol8 p6 (Rej)");
				tf1_W2_fullFit_rej->SetParName(10, "W2 BG Pol8 p7 (Rej)");
				tf1_W2_fullFit_rej->SetParName(11, "W2 BG Pol8 p8 (Rej)");

			//Fix parameters from the BG_reject fit
				tf1_W2_fullFit_rej->FixParameter(3, parRej[0]);
				tf1_W2_fullFit_rej->FixParameter(4, parRej[1]);
				tf1_W2_fullFit_rej->FixParameter(5, parRej[2]);
				tf1_W2_fullFit_rej->FixParameter(6, parRej[3]);
				tf1_W2_fullFit_rej->FixParameter(7, parRej[4]);
				tf1_W2_fullFit_rej->FixParameter(8, parRej[5]);
				tf1_W2_fullFit_rej->FixParameter(9, parRej[6]);
				tf1_W2_fullFit_rej->FixParameter(10, parRej[7]);
				tf1_W2_fullFit_rej->FixParameter(11, parRej[8]);
		...
		//------------------------------------------------------------
			...
			h_tf_W2_bg_rej = (TH1*)tf1_W2_bg_pol8_rej_full->GetHistogram();
